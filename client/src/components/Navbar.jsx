        ...
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all z-50">
            ...
            <div className="hidden md:flex items-center gap-6 ml-7">
                <NavLink to="/" className="relative overflow-hidden h-6 group">
                    ...
                    <span className="block absolute top-full left-0 group-hover:translate-y-[-100%] text-orange-600 transition-transform duration-300">Home</span>
                </NavLink>
                ...
                <NavLink to="/products" className="relative overflow-hidden h-6 group">
                    ...
                    <span className="block absolute top-full left-0 group-hover:translate-y-[-100%] text-orange-600 transition-transform duration-300">All Products</span>
                </NavLink>
                {/* Search Bar */}
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-500 px-3 rounded-full">
                    <input onChange={(e) => setSearchQuery(e.target.value)} className="py-1.5 w-full bg-transparent outline-none placeholder-gray-600"
